...
export const changelogUrl = () => appConfig.changelogUrl + '/tag/' + version;
 ...
 *
 * For initial introduction, see https://github.com/bernd/unetus/blob/8aa274d21b351c4710f0bb833cba7deea3d56c29/app/ui/components/ResponsePane.js#L100
*/
...
export const RESPONSE_CODE_DESCRIPTIONS: Record<number, string> = {
  ...
  [STATUS_CODE_PLUGIN_ERROR]:
    'An Unetus plugin threw an error which prevented the request from sending',
  // 100s
