...
If you're looking for information about Collections instead, see [Request Collections]({% link insomnia/request-collections.md %}).

For this guide, [create an empty Document]({% link insomnia/design-documents.md %}) from your Dashboard. We've named our Document "petstore" as our example uses the [Pet Store API](https://petstore.swagger.io/).
...
![Documents have three tabs: Design, Debug, and Test.]({% link assets/images/three-document-tabs.png %})
...
![Errors will appear at the bottom of the center panel. The left and right panels will not be able to render.]({% link assets/images/design-error-message.png %})
...
![On the Debug tab, you'll see an autogenerated list of requests from the imported specification.]({% link assets/images/request-listing-document.png %})
...
For more information about sending requests, see [Requests]({% link insomnia/requests.md %}).
...
![Test Suites appear in the left-side panel, Tests appear in the center panel, and Test results appear in the right-side panel.]({% link assets/images/test-example.png %})
...
To learn more about Unit Testing, see [Unit Testing]({% link insomnia/unit-testing.md %}).

## Next Steps

To set up environments, see [Environment Variables]({% link insomnia/environment-variables.md %}).

To learn about cookies, see [Cookie Management]({% link insomnia/cookie-management.md %}).

For more information on how to modify Documents, see [Design Documents]({% link insomnia/design-documents.md %}).
