...
Refer to [Chaining Requests]({{ site.baseurl }}{% link insomnia/chaining-requests.md %}) and select the chained request from the **Select Request** dropdown.
...
1. Open [DevTools]({{ site.baseurl }}{% link insomnia/introduction-to-plugins.md %}#debug-in-the-insomnia-app).
